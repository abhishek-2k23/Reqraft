          ...
          <div className="grid gap-4">
            {reviewedFeatures.map((feature) => (
              <motion.div variants={FADE_UP_ANIMATION_VARIANTS} key={feature.id}>
                <Link href={`/features/${feature.id}?tab=review-history`} className="group block overflow-hidden rounded-2xl border border-white/10 bg-zinc-950/40 p-6 shadow-2xl backdrop-blur-xl transition-all hover:border-white/20 hover:bg-zinc-900/40">
