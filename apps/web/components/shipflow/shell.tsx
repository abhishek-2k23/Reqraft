  ...
  return (
    <main className="min-h-screen bg-[#090b10] text-slate-100">
      <div className="grid min-h-screen lg:grid-cols-[260px_1fr]">
        <aside className="border-r border-white/10 bg-[#0d1118] px-4 py-5">
          <Link href="/" className="flex items-center gap-3 rounded-lg px-2 py-2">
            ...
            <div>
              <p className="text-sm font-semibold text-white">ShipFlow AI</p>
        ...
        <section className="min-w-0">
          <header className="border-b border-white/10 px-5 py-5 sm:px-8">
            <p className="text-xs uppercase tracking-[0.24em] text-cyan-200">Acme Cloud</p>
